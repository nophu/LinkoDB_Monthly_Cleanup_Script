...
def _group(changes, field_order):
    ...
    One entry per unique facility, fields in rubric order, deduplicated.
    """
    seen  = {}   # (facility, permit, field) -> True
    order = {}   # (facility, permit)        -> list of (field, original, suggestion)
